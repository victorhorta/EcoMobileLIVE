...
public class EcoCSVObject implements Serializable {
    ...
    public final static String SENSOR_ECOMONITOR_NAME = "ECOMON";
    public final static String SENSOR_ECOMINI_NAME = "ECOMINI";
    public final static String SENSOR_ECONANO_NAME = "ECONANO";

    public final static int SENSOR_ECOMONITOR = 1;
    public final static int SENSOR_ECOMINI = 2;
    public final static int SENSOR_ECONANO = 3;

    // public static final LockableSparseArray<String> aSensorTypes;
    // static {
    // aSensorTypes = new LockableSparseArray<String>();
    // aSensorTypes.put(SENSOR_ECOMONITOR, SENSOR_ECOMONITOR_NAME);
    // aSensorTypes.put(SENSOR_ECOMINI, SENSOR_ECOMINI_NAME);
    // aSensorTypes.put(SENSOR_ECONANO, SENSOR_ECONANO_NAME);
    // aSensorTypes.lock();
    // }

    public static final HashMap<String, Integer> aSensorTypes;
    static {
        aSensorTypes = new HashMap<String, Integer>();
        aSensorTypes.put(SENSOR_ECOMONITOR_NAME, SENSOR_ECOMONITOR);
        aSensorTypes.put(SENSOR_ECOMINI_NAME, SENSOR_ECOMINI);
        aSensorTypes.put(SENSOR_ECONANO_NAME, SENSOR_ECONANO);
        Collections.unmodifiableMap(aSensorTypes);
    }
